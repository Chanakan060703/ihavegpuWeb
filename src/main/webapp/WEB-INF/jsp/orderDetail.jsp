...
<div class="nav">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <a href="${pageContext.request.contextPath}/open_register">
...
<div class="mainhead">
    ...
    <div class="container">
        ...
        <h3>วันที่สั่งซื้อ: ${receipt.date}</h3>
        ...
        <table class="table">
            ...
            <tbody>
                <c:forEach var="detail" items="${receiptDetails}">
    				<tr>
        				<td>${detail.id.product.product_name}</td>
        				<td>฿${detail.id.product.price}</td>
        				<td>${detail.amount}</td>
        ...
        <div class="total-price">ยอดรวมทั้งหมด: ฿${receipt.total}</div>

        <div class="text-center">
            <a href="${pageContext.request.contextPath}/receipt/Open_orderHistory" class="btn">กลับไปที่ประวัติการสั่งซื้อ</a>
        </div>
    </div>
</body>
</html>
